...
class Robot:
    def __init__(self,pybullet_api,opti,start_pos=[0.4,0.3,0.4],urdf_path=None):
       ...
       self.robotId = self.p.loadURDF(os.path.join(HOME_DIR,"ConceptManipulation/simulation/urdf","panda_robotiq_cup_2.urdf"), [0, 0, 0],useFixedBase=True,flags=self.p.URDF_USE_SELF_COLLISION and self.p.URDF_USE_SELF_COLLISION_INCLUDE_PARENT) 
