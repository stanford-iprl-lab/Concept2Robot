...
#    classes.append(elem)
#sorted(classes)
classes = ["Moving something up","Moving something higher","Putting something up","Putting an object higher","Moving something down","Moving something lower","Puting something lower","Putting an object lower"]
